...
class Penjualan extends Model
{
    ...
    {
        return Barang::where('id',$id)->first()->nama_barang;
    }
    public function satuan($inp)
    {
       if ($inp == 1){return "Satu ";}
       else if ($inp == 2){ return "Dua "; }
       else if ($inp == 3){ return "Tiga "; }
       else if ($inp == 4){ return "Empat "; }
       else if ($inp == 5){ return "Lima "; }
       else if ($inp == 6){ return "Enam "; }
       else if ($inp == 7){ return "Tujuh "; }
       else if ($inp == 8){ return "Delapan "; }
       else if ($inp == 9){ return "Sembilan "; }
       else { return ""; }
    }
